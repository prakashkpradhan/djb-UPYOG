...
const DocumentIcon = ({ className, styles, width = "24", height = "24", ...props }) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 18 18"
...
const Calender = ({ className, onClick, styles, width = "24", height = "24", ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
export const HomeIcon = ({ className, styles, width = "24", height = "24", ...props }) => (
  <svg className={className} viewBox="0 0 24 24" style={{ ...styles }} width={width} height={height} fill="currentColor" {...props}>
...
const ComplaintIcon = ({ className, styles, width = "48", height = "48", ...props }) => (
  <svg
    style={{ ...styles }}
    className={className}
    viewBox="0 0 48 48"
...
const CHBIcon = ({ styles, className, width = "24", height = "24", ...props }) => (
  <svg
    width={width}
    height={height}
    className={className}
...
const HelpIcon = ({ className, styles, width = "24", height = "18", ...props }) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 18"
...
const CameraIcon = ({ size = 40, color = "#a82227", className = "" }) => (
...
const EditPencilIcon = ({ className = "", size = 18, width, height, color = "#505A5F", ...props }) => (
  <svg
    className={className}
    width={width || size}
    height={height || size}
...
const PTRIcon = ({ className, styles }) => (
  <svg width="512" height="512" style={{ ...styles }} viewBox="0 0 512 512" fill="#ffffff" className={className} xmlns="http://www.w3.org/2000/svg">
    <path
      d="M256 224c-79.41 0-192 122.76-192 200.25 0 34.9 26.81 55.75 71.74 55.75 48.84 0 81.09-25.08 120.26-25.08 39.51 0 71.85 25.08 120.26 25.08 44.93 0 71.74-20.85 71.74-55.75C448 346.76 335.41 224 256 224zm-147.28-12.61c-10.4-34.65-42.44-57.09-71.56-50.13-29.12 6.96-44.29 40.69-33.89
...
const MdUploadIcon = ({ size = 24, color = "currentColor", className = "", ...props }) => {
  return (
    <svg
      stroke={color}
      fill={color}
...
const UploadCloudIcon = ({ size = 24, color = "currentColor", className = "", style = {}, uploading, progress, gradientColor = "#ccdaf4" }) => {
  const gradientId = useRef(`cloudGradient-${Math.random().toString(36).substr(2, 9)}`);
  return (
    <svg
      stroke={color}
      fill={color}
      ...
      height={size}
      width={size}
      className={`${className} ${uploading ? "cloud-uploading" : ""}`}
      style={style}
      xmlns="http://www.w3.org/2000/svg"
    >
      <defs>
        <linearGradient id={gradientId.current} x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <stop offset={`${progress}%`} stopColor={gradientColor} />
