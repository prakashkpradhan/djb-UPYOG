...
const CheckPage = ({ onSubmit, value }) => {
  ...
  else if (value.businessService === "BPA_OC") BusinessService = "BPA.NC_OC_APP_FEE";
  ...
  let routeLink = !isEditApplication
    ? `/digit-ui/citizen/obps/ocbpa/${additionalDetails?.applicationType.toLowerCase()}/${additionalDetails?.serviceType.toLowerCase()}`
    : `/digit-ui/citizen/obps/editApplication/ocbpa/${value?.tenantId}/${value?.applicationNo}`;
      ...
      <Card style={{ paddingRight: "16px" }}>
        ...
        <StatusTable>
          <Row
            ...
            text={convertEpochToDateDMY(Number(data?.applicationDate))}
          />
      ...
      <Card style={{ paddingRight: "16px" }}>
        <StatusTable>
          ...
          <Row
            ...
            text={datafromAPI?.planDetail?.planInformation?.plotNo || t("CS_NA")}
          />
          <Row
            className="border-none"
            label={`${t(`BPA_KHATHA_NUMBER_LABEL`)}`}
            text={datafromAPI?.planDetail?.planInformation?.khataNo || t("CS_NA")}
          />
      ...
      <Card style={{ paddingRight: "16px" }}>
        ...
        <StatusTable>
          <Row
            ...
            text={
              datafromAPI?.planDetail?.blocks?.[0]?.building?.totalBuitUpArea
                ? `${datafromAPI?.planDetail?.blocks?.[0]?.building?.totalBuitUpArea} ${t("BPA_SQ_MTRS_LABEL")}`
                : t("NA")
            }
          ></Row>
          <Row
              ...
              >
                ...
                <StatusTable>
                  ...
                  <Row
                    ...
                    textStyle={
                      noc?.applicationStatus == "APPROVED" || noc?.applicationStatus == "AUTO_APPROVED" ? { color: "#2E9E8F" } : { color: "#D83A2F" }
                    }
                  />
