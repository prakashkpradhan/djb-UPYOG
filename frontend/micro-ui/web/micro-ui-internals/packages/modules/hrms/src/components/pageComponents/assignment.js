  ...
  return (
    <div key={index + 1} style={{ border: "1px solid #E3E3E3", borderRadius: "6px" }}>
      ...
      <div className="juridiction-form">
        <LabelFieldPair>
          <CardLabel className={assignment?.id ? "card-label-smaller disabled-label" : "card-label-smaller"}>
        ...
        <LabelFieldPair>
          <CardLabel className={assignment?.isCurrentAssignment ? "card-label-smaller disabled-label" : "card-label-smaller"}>
        ...
        <LabelFieldPair>
          <CardLabel className={assignment?.id ? "card-label-smaller disabled-label" : "card-label-smaller"}> {`${t("HR_DEPT_LABEL")} * `}</CardLabel>
          <Dropdown
        ...
        <LabelFieldPair>
          <CardLabel className={assignment?.id ? "card-label-smaller disabled-label" : "card-label-smaller"}>{`${t("HR_DESG_LABEL")} * `}</CardLabel>
          <Dropdown
            className="form-field"
